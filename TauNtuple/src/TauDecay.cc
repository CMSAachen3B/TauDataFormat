...
void TauDecay::ClassifyDecayMode(unsigned int &JAK_ID,unsigned int &TauBitMask){
  ...
  //JAK_K0BK0PI
  if ((n_K0L==2 && n_pi==1 && n_pi0==0 && n_K0S==0) || (n_K0L==0 && n_pi>=1 && n_pi0==0 && n_K0S==2) ){
    JAK_ID=JAK_K0BK0PI;
    TauBitMask=OneProng;
  ...
  //JAK_KK0B
  if(n_e==0 && n_mu==0 && n_pi0==0 && n_K==1 && n_K0L==0 && n_K0S==1 && n_nu==1){
    JAK_ID=JAK_KK0B;
    TauBitMask=OneProng;
  ...
  //JAK_ID=JAK_KK0BPI0
  if(n_e==0 && n_mu==0 && n_pi0==1 && n_K==1 && n_K0L==0 && n_K0S==1  && n_nu==1){
    JAK_ID=JAK_KK0BPI0;
    TauBitMask=OneProng;
    TauBitMask+=OnePi0;
    if(n_pi==2)TauBitMask+=KS0_to_pipi;
