...
NtupleMaker = cms.EDProducer('TauNtuple',
                             ...
                             hpsPFTauDiscriminationAgainstMuonLoose=cms.InputTag("hpsPFTauDiscriminationAgainstMuonLoose"),
                             hpsPFTauDiscriminationAgainstMuonTight=cms.InputTag("hpsPFTauDiscriminationAgainstMuonTight"),
